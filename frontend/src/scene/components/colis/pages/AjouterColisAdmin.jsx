...
import ColisFormAdmin from '../components/ColisFormAdmin';

function AjouterColisAdmin() {
    ...
    <main className="page-main">
        ...
        >
            ...
            >
                ...
                <ColisFormAdmin theme={theme} darkStyle={darkStyle} type={type}/>
            </div>
        </div>
    </main>
</div>
...
export default AjouterColisAdmin;